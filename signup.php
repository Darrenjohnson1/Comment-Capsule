...
<head>
  ...
  <title>Comment Capsule - Sign Up</title>
...
<body>
  ...
  <header class="header  p-3 bg-dark start-0 top-0 end-0">
    <div class="d-flex justify-content-between container-custom align-items-center">
      ...
      <div>
          <a href="login.php" class="mt-2 btn btn-default text-white btn-link" role="button">Log In</a>
  ...
  <section class="steps container-custom">
    ...
    <div class="row">
      <div class="d-none d-lg-block col-12 col-sm-6 d-md-flex justify-content-md-ceneter pb-4">
        <img src="img\guilherme-stecanella-EefsBN5B5GE-unsplash.jpg" alt="sands of time" class="img-fluid steps__section-thumbnail rounded" width="553" height="746" loading="lazy">
      </div>
